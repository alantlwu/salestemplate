...
# 定義公版選項與對應欄位
templates = {
    "Lead/PDC": ["Model", "現有車款", "用車習慣", "充電規劃", "比較車款", "吸引及在乎之處", "備註"],
    "Trade-in": ["廠牌車型", "年份", "里程", "所在地","購入價格", "備註"],
    "Order": ["訂購人", "付款方式", "車輛登記人姓名", "車輛登記人地址", "充電座安裝","充電座安裝地址", "安裝建物類型及名稱", "車輛換購", "期望交付期間", "交車地點", "推薦碼", "備註"],
    "TD Note": ["目標 Model", "換購車動機", "考慮比較的競品", "疑慮(不購車的原因)", "購買時間", "決策者/ 使用人", "充電規劃", "平常開車的用途", "目前使用車輛", "是否Trade in",  "備註", "C/E/T/N", "Next Step"],
    "PDC SMS": [],
    "PDC 威脅 SMS": [],
...
"""
    ...
    if selected_template == "Lead/PDC":
        selected_person = st.selectbox("#", ["Cedric*", "Demi*", "Joe*", "Leo*", "Mandy*", "Steven*", "Tinny*", "Valeria*", "Vian*","Winston*", "支援*", "ISA*" ], index=None, placeholder="選擇人名")
        if selected_person:
